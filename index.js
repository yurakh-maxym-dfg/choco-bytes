import{a as $,R as q,C as B,S as C,N as P,P as D,A as I}from"./assets/vendor-Cl5Ul_Kf.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();function T(e){const t=document.querySelector(".categories-desktop");if(!t)return;const r=[{_id:"all",name:"Всі десерти"},...e].map(({_id:n,name:o},i)=>`
      <label>
        <input
          type="radio"
          name="category"
    ...
    `).join("");t.innerHTML=r}const O="/choco-bytes/img/icons.svg";function A(e,t=!1){const s=document.querySelector(".desserts-list"),r=e.map(({_id:n,image:o,category:i,name:w,description:k,price:_})=>`
        <li class="dessert-card">
          ...
          <div class="dessert-card__block">
            <p class="dessert-card__price">${_} грн</p>
    ...
    >
      <svg class="dessert-details-btn__icon" width="24" height="24">
        <use href="${O}#icon-arrow-outward"></use>
      </svg>
    </button>
          </div>
        </li>
